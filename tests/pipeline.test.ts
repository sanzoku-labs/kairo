...
describe('Pipeline', () => {
  ...
  describe('basic pipeline operations', () => {
    ...
    it('should handle errors in map', async () => {
      const pipe = pipeline<number>('error-test')
        .map(x => {
  ...
  describe('fetch operations', () => {
    it('should fetch data successfully', async () => {
      ...
      const pipe = pipeline('fetch-test', { httpClient: mockHttpClient })
        .fetch('/api/users/1')
    ...
    it('should handle HTTP errors', async () => {
      ...
      const pipe = pipeline('fetch-error', { httpClient: mockHttpClient })
        .fetch('/api/users/999')
    ...
    it('should handle network errors', async () => {
      ...
      const pipe = pipeline('network-error', { httpClient: mockHttpClient })
        .fetch('/api/users')
    ...
    it('should use dynamic URL', async () => {
      ...
      const pipe = pipeline<{ id: number }>('dynamic-url', { httpClient: mockHttpClient })
  ...
  describe('error handling', () => {
    ...
    it('should short-circuit on first error', async () => {
      ...
      const pipe = pipeline('short-circuit')
        .input(inputSchema)
        .map(fn1)
        .map(fn2)
